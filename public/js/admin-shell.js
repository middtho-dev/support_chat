...
window.AdminShell = (() => {
  ...
  function paint(){
    ...
    if(state.permissions.canManageSettings)cards.push(['frp','FRP · удалённый доступ','frp'],['voice','Голосовые Telegram','voice'],['lampac','Lampac','lampac'],['torrents','TorrServer','lampac'],['devices','Устройства Lampa','lampac']);
