...
window.LampacPanel=(()=>{
  ...
  function state(d){
    ...
    const running=d.service.ActiveState==='active';$('lc-toggle').dataset.action=running?'stop':'start';$('lc-toggle').textContent=running?'Остановить':'Запустить';$('lc-toggle').className=running?'danger':'save';
