...
function applySettingsDependencies() {
  ...
  setDependentControls('set-tg-customer-enabled', ['set-tg-customer-files','set-tg-customer-replies','set-tg-customer-new','set-tg-customer-reopened','set-tg-customer-closed','set-tg-customer-closed-user','set-tg-customer-closed-support','set-tg-customer-closed-system','set-tg-customer-close-prompt','set-tg-customer-close-btn','set-tg-customer-new-btn','set-tg-customer-send-close-btn']);
