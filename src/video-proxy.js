'use strict';
function createVideoProxy({authorize,url=process.env.VIDEO_SERVICE_URL||'http://127.0.0.1:7800',token=process.env.VIDEO_SERVICE_TOKEN}={}){
...
module.exports={createVideoProxy};
